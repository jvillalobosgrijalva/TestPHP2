...
(function ($) {
    ...
    $.fn.circliful = function (options, callback) {
        ...
        return this.each(function () {
            ...
            if (settings.icon !== 'none' && settings.icon!="") {
				icon = `<text id='circlifulIcon`+id+`' text-anchor="middle"  fill="` + settings.iconColor + `" font-family="'Font Awesome 5 Free" font-weight="700" style="font-size: ` + settings.iconSize + `px" transform="translate(`+iconX+` `+iconY+`)"></text>`;
            } else {
                icon = '';
            }

			if(settings.title!="")
				title='<text x="50%" y="105" dominant-baseline="middle" text-anchor="middle" style="font-weight: bold; font-size: 15; fill:' + settings.iconColor + '">'+settings.title+'</text>';
			else
				title ="";
			...
			$("#circlifulIcon"+id).text(function(d) { return getUnicode(settings.icon);}); 
