...
//			node.nodeIdInt = this._nodes==null?1:this._nodes.length+1;
//			node.parentIdInt = parent.nodeIdInt;
//			
	...
	Tree.prototype._renderNode = function (node, previousNode) {
		...
		if(this._options.itemRenderer!=null)
		{
			//node.$el.append(this._options.itemRenderer(node));
			node.$el.html(this._options.itemRenderer(node,node.$el.html()));
		}
