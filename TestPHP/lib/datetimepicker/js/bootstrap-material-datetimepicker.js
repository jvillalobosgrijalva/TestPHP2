   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '</div>' +
                         '<div class="dtp-actual-year text-primary p80'+(this.params.year?"":" disabled")+'">2014</div>' +
                         '<div class="right center">' +
                         ...
                         '<button class="dtp-btn-cancel btn btn-dark">' + this.params.cancelText + '</button>' +
